...
const DischargeMedication = () => {
  ...
  const canCreateDischargeMedication = ability.can(
    "create",
    "dischargeMedication"
  );
      ...
      {canCreateDischargeMedication && (
        ...
        >
          <Button
            ...
            onClick={() => showModal()}
          >
            <PlusOutlined /> Discharge Medication
          </Button>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item
                ...
                name="drugName"
                rules={[
                  { required: true, message: "Please select a drug name!" },
                ]}
                hasFeedback
              >
