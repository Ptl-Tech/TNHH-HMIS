...
const Vitals = () => {
  ...
  return (
    <div>
      ...
      {isVitalFormVisible && (
        <VitalsFormData
          observationNumber={patientDetails?.Admission_No}
          patientNumber={patientDetails?.Patient_No}
          setIsVitalFormVisible={setIsVitalFormVisible}
      ...
      {!isVitalFormVisible && (
        <VitalsTable
          ...
          filterVitals={filterInpatientVitals}
          loadingInpatientVitals={loadingInpatientVitals}
        />
      )}
      ...
      >
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item label="Blood Pressure (mmHg)" name="bloodPreasure">
                <Input type="text" disabled />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Temperature (&deg;C)" name="temperature">
                <Input type="number" disabled />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item label="SPO2 (%)" name="sP02">
                <Input type="text" disabled />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Respiration Rate (bpm)" name="respirationRate">
                <Input type="text" disabled />
              </Form.Item>
            </Col>
            <Col span={12}>
