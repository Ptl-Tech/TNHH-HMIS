...
const ReadNurseNotes = () => {
  ...
  const canReadNurseNotes = ability.can("read", "nurseNotes");
  ...
  const filterNurseNotes = getNurseNotes?.filter(
    (note) => note?.AdmissionNo === patientDetails?.Admission_No
  );
  ...
  const patientInfo = [
    ...
    },
    {
      ...
      value: formatDate(patientDetails?.Expected_Date_of_Discharge),
    },
  ];
