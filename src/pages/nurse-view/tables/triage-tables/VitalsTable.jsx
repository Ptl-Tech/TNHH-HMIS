...
const VitalsTable = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "SP02",
      render: (_, record) => {
        return record.SP02 ? <span>{record.SP02}</span> : <span>0</span>;
      },
    },
    {
      title: "Height",
      ...
      key: "Height",
      render: (_, record) => {
        return record.Height ? <span>{record.Height} cm</span> : <span>0</span>;
      },
    },
    {
      title: "Weight",
      ...
      key: "Weight",
      render: (_, record) => {
        return record.Weight ? <span>{record.Weight} kg</span> : <span>0</span>;
      },
    },
    {
      title: "Temperature",
      ...
      render: (_, record) => {
        ...
        if (temperature > 37) {
          return (
            ...
            >
              {temperature} &deg;C <Badge color="red" text="High" />
            </span>
          );
          ...
          return (
            <span
              style={{ display: "flex", alignItems: "center", gap: "10px" }}
            >
              {temperature} &deg;C <Badge color="orange" text="Low" />
            </span>
          );
        } else {
          return (
            <span
              style={{ display: "flex", alignItems: "center", gap: "10px" }}
            >
              {temperature} &deg;C <Badge color="green" text="Normal" />
            </span>
          );
        }
      },
