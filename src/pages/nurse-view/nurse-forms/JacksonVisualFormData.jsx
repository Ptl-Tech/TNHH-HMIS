  ...
  return (
    <>
      <Row gutter={[16, 16]}>
          ...
          >
            ...
            >
              <Select
                ...
                options={[
                  { value: "0", label: "0 - No Sign of Phlebitis" },
                  { value: "1", label: "1 - Possible first sign of Phlebitis" },
                  { value: "2", label: "2 - Early Stage of Phlebitis" },
                  { value: "3", label: "3 - Medium Stage of Phlebitis" },
                  { value: "4", label: "4 - Advanced Stage of Phlebitis or start of thrombophlebitis" },
                  { value: "5", label: "5 - Advanced Stage of thrombophlebitis" },
                ]}
              />
            </Form.Item>
            <Form.Item>
        ...
        <Col span={12}>
          <Image src={jacksonVisualImage} width={500} height={230} />
        </Col>
      </Row>
    </>
  );
