...
const TransferBedForm = () => {
  return (
    <Card style={{ margin: '20px 10px 10px 10px' }}>
        ...
        <Space>
            <Form.Item >
                <Button type="primary" htmlType="submit">Transfer Bed</Button>
            </Form.Item>
            <Form.Item >
                <Button color="danger" variant="outlined">Cancel Bed Transfer</Button>
            </Form.Item>
        </Space>
        </Form>
    </Card>
...
export default TransferBedForm