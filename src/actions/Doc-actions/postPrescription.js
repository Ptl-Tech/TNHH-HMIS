...
export const POST_INPATIENT_PRESCRIPTION_REQUEST = "POST_INPATIENT_PRESCRIPTION_REQUEST";
export const POST_INPATIENT_PRESCRIPTION_SUCCESS = "POST_INPATIENT_PRESCRIPTION_SUCCESS";
export const POST_INPATIENT_PRESCRIPTION_FAIL = "POST_INPATIENT_PRESCRIPTION_FAIL";
export const POST_INPATIENT_PRESCRIPTION_RESET = "POST_INPATIENT_PRESCRIPTION_RESET";

export const POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_REQUEST = "POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_REQUEST";
export const POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_SUCCESS = "POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_SUCCESS";
export const POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_FAIL = "POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_FAIL";
export const POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_RESET = "POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_RESET";
...
export const postInPatientPrescriptionDetails = (prescription) => async (dispatch, getState) => {
  try {
   ...
   setTimeout(() => {
     // Dispatch success action
     dispatch({ type: POST_INPATIENT_PRESCRIPTION_SUCCESS, payload: responseData });
...
export const sendtoPharmacy = (treatmentId) => async (dispatch, getState) => {
  ...
  export const InpatientSendToPharmacy = (treatmentId) => async (dispatch, getState) => {
    try {
        ...
        dispatch({ type: POST_INPATIENT_PRESCRIPTION_TO_PHARMACY_SUCCESS, payload: responseData });
