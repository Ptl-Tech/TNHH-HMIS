...
export const REQUEST_TREATMENT_DIAGNOSIS_LINES =
  "REQUEST_TREATMENT_DIAGNOSIS_LINES";
export const REQUEST_TREATMENT_DIAGNOSIS_LINES_SUCCESS =
  "REQUEST_TREATMENT_DIAGNOSIS_LINES_SUCCESS";
export const REQUEST_TREATMENT_DIAGNOSIS_LINES_FAIL =
  "REQUEST_TREATMENT_DIAGNOSIS_LINES_FAIL";
export const REQUEST_TREATMENT_DIAGNOSIS_LINES_RESET =
  "REQUEST_TREATMENT_DIAGNOSIS_LINES_RESET";

export const getTreatmentDiagnosisLinesSlice =
  (treatmentNo) => async (dispatch, getState) => {
    try {
      ...
      dispatch({
        type: REQUEST_TREATMENT_DIAGNOSIS_LINES_SUCCESS,
      ...
      const errorMessage =
        ...
        error.message ||
        "Failed to fetch treatment diagnosis lines";

      // Display error notification
      message.error(errorMessage);

      dispatch({
        type: REQUEST_TREATMENT_DIAGNOSIS_LINES_FAIL,
