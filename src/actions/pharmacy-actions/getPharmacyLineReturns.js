...
export const GET_PHARMACY_RETURN_LIST_SUCCESS = "GET_PHARMACY_RETURN_LIST_SUCCESS";
export const GET_PHARMACY_RETURN_LIST_FAILURE = "GET_PHARMACY_RETURN_LIST_FAILURE";
export const GET_PHARMACY_RETURN_LIST_RESET = "GET_PHARMACY_RETURN_LIST_RESET";

// Action Types for Patient Pharmacy Return
export const GET_PATIENT_PHARMACY_RETURN_REQUEST = "GET_PATIENT_PHARMACY_RETURN_REQUEST";
export const GET_PATIENT_PHARMACY_RETURN_SUCCESS = "GET_PATIENT_PHARMACY_RETURN_SUCCESS";
export const GET_PATIENT_PHARMACY_RETURN_FAILURE = "GET_PATIENT_PHARMACY_RETURN_FAILURE";
export const GET_PATIENT_PHARMACY_RETURN_RESET = "GET_PATIENT_PHARMACY_RETURN_RESET";
...
export const getPharmacyLineReturnList = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({ type: GET_PHARMACY_RETURN_LIST_SUCCESS, payload: response.data });
  } catch (error) {
    // Handle error and show a message using Ant Design
    const errorMessage =
      error.response?.data?.message || error.message || "Failed to fetch pharmacy line returns";
...
export const getPharmacyLineReturnbyPharmacyNo = (pharmacyNo) => async (dispatch, getState) => {
  try {
    ...
    // Dispatch success with the response data
    dispatch({ type: GET_PATIENT_PHARMACY_RETURN_SUCCESS, payload: response.data });
  } catch (error) {
    // Handle error and show a message using Ant Design
    const errorMessage =
      error.response?.data?.message || error.message || "Failed to fetch pharmacy return data";

    message.error(errorMessage);

    // Dispatch failure with the error message
    dispatch({ type: GET_PATIENT_PHARMACY_RETURN_FAILURE, payload: errorMessage });
  }
};
