...
export const GET_QY_TREATMENT_DIAGNOSIS_LINES_REQUEST = 'GET_QY_LOCATION_REQUEST';
export const GET_QY_TREATMENT_DIAGNOSIS_LINES_SUCCESS = 'GET_QY_LOCATION_SUCCESS';
export const GET_QY_TREATMENT_DIAGNOSIS_LINES_FAILURE = 'GET_QY_LOCATION_FAILURE';
