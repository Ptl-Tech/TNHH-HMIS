...
export const GET_PATIENT_VITALS_BY_PATIENT_NUMBER_REQUEST = 'GET_PATIENT_VITALS_BY_PATIENT_NUMBER_REQUEST';
export const GET_PATIENT_VITALS_BY_PATIENT_NUMBER_SUCCESS = 'GET_PATIENT_VITALS_BY_PATIENT_NUMBER_SUCCESS';
export const GET_PATIENT_VITALS_BY_PATIENT_NUMBER_FAILURE = 'GET_PATIENT_VITALS_BY_PATIENT_NUMBER_FAILURE';
...
export const getSinglePatientAllVitalsLines = (patientNumber) => async (dispatch, getState) => {
   
    const config = configHelpers(getState);
    try {
        dispatch({ type: GET_PATIENT_VITALS_BY_PATIENT_NUMBER_REQUEST });
        const { data } = await axios.get(`${API_URL}/data/odatafilter?webservice=QyVitalsLines&isList=true&query=$filter=PatientNo eq '${patientNumber}'`, config);

        dispatch({ type: GET_PATIENT_VITALS_BY_PATIENT_NUMBER_SUCCESS, payload: data })

        return { type: GET_PATIENT_VITALS_BY_PATIENT_NUMBER_SUCCESS, payload: data };
        ...
        return { type:GET_PATIENT_VITALS_BY_PATIENT_NUMBER_FAILURE, payload: error };
    }
}
