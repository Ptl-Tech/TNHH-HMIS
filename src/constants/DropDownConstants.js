...
export const SUB_COUNTY_WARDS_LIST_SUCCESS = "SUB_COUNTY_WARDS_LIST_SUCCESS";
export const SUB_COUNTY_WARDS_LIST_REQUEST = "SUB_COUNTY_WARDS_LIST_REQUEST";
export const SUB_COUNTY_WARDS_LIST_FAIL = "SUB_COUNTY_WARDS_LIST_FAIL";
export const SUB_COUNTY_WARDS_LIST_RESET = "SUB_COUNTY_WARDS_LIST_RESET";
