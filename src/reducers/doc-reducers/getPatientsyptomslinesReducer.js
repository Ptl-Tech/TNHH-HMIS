...
export const getPatientsyptomslinesReducer = (state = { data: [] }, action) => {
  switch (action.type) {
    case GET_PATIENT_SYPTOM_LINES_REQUEST:
      return { loading: true, data: [] };
    case GET_PATIENT_SYPTOM_LINES_SUCCESS:
      return { loading: false, data: action.payload };
    case GET_PATIENT_SYPTOM_LINES_FAIL:
      return { loading: false, error: action.payload };
    case GET_PATIENT_SYPTOM_LINES_RESET:
