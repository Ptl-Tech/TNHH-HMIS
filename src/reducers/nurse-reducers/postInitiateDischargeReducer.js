...
export const postDischargeSummaryReducer = (state = initialStateDischarge, action) => {
    switch (action.type) {
...
export const getQyDischargeSummaryReducer = (state = initialStateDischarge, action) => {
    switch (action.type) {
