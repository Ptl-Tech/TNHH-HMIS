import {
    ...
    GET_SINGLE_INPATIENT_ALLERGIES_REQUEST,
    GET_SINGLE_INPATIENT_ALLERGIES_SUCCESS,
    GET_SINGLE_INPATIENT_ALLERGIES_FAILURE,
...
export const getSingleInpatientAllergies = (state = initialState, action) => {
    switch (action.type) {
        case GET_SINGLE_INPATIENT_ALLERGIES_REQUEST:
            return { ...state, loadingAllergies: true };
        case GET_SINGLE_INPATIENT_ALLERGIES_SUCCESS:
            return { ...state, loadingAllergies: false, allergies: action.payload };
        case GET_SINGLE_INPATIENT_ALLERGIES_FAILURE:
            return { ...state, loadingAllergies: false, error: action.payload };
        default:
            return state;
    }
