...
export const visitorByIdReducer = (state = {}, action) => {
  switch (action.type) {
    case VISITOR_BY_ID_REQUEST:
      return { loading: true, visitor: {} };
    case VISITOR_BY_ID_SUCCESS:
      return { loading: false, visitor: action.payload };
    case VISITOR_BY_ID_FAIL:
      return { loading: false, error: action.payload };
    case VISITOR_BY_ID_RESET:
      return { visitor: {} };
    default:
      return state;
  }
